...
@WebServlet("/downloadResourceAttachment")
public class DownloadResourceAttachmentServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
	   ...
	   GroupAttachment attachment = (GroupAttachment)request.getAttribute("attachment");
