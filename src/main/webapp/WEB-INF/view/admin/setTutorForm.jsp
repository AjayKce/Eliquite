...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
        ...
        <li class="activeTab"><a href="${pageContext.request.contextPath}/setTutor"><span class="glyphicon glyphicon-adjust"></span> Set Tutor</a></li>
...
<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<form:form method="post" action="processAddTutorForm" modelAttribute="tutor">
					<form:hidden path="id" />
				...
				<table class="table table-responsive">
					...
					<%for(Tutor temp:tutors){ %>
						<tr>
							...
							<td>
							<form onsubmit="return confirm('Do you really want to delete ?')" action="deleteTutor" method="post" style="margin:0px;padding:0px;border:0px;">
