			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
				<table class="table table-responsive">
					...
					<tr class="rowborder">
						...
						<td>
							<form action="viewStudentsForFeedBack" method="post" style="margin:0px;padding:0px;border:0px;">
								<input type="hidden" name="subjectCode" value="<%=temp.getSubjectCode() %>" />
								<input type="hidden" name="staffName" value="<%=temp.getStaffName() %>" />
								<button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-tag"></span> students</button>
							</form>
						</td>
					</tr>
					<%} %>
