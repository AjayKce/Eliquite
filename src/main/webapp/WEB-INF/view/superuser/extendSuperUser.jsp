...
<link
	href="/stylesheet/createSuperUser.css"
	rel="stylesheet">
<style type="text/css">
.activeTab a {
	font-weight: bolder;
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
        ...
        <li class="activeTab"><a href="${pageContext.request.contextPath}/extendSuperUser"><span class="glyphicon glyphicon-plus"></span> Extend SuperUser</a></li>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<form:form method="post" action="processCreateSuperUser"
