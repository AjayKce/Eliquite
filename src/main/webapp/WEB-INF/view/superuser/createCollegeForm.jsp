...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
        ...
        <li class="activeTab"><a href="${pageContext.request.contextPath}/addCollege"><span class="glyphicon glyphicon-plus"></span> Add College</a></li>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<%
					if (request.getAttribute("invalidCollege") != null) {
				%>
				<p style="color: red">This college is already registered!!!!</p>
				<%
					}
				%>
				<form:form method="post" action="processCreateCollegeForm" modelAttribute="college">
					<form:hidden path="id" />
