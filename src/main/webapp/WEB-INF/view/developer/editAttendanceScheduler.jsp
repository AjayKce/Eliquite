	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
				<form:form method="post" action="/console/processEditAttendanceScheduler" modelAttribute="attendanceScheduler">
					<form:hidden path="id" />
					...
					<label for="hour">Period : </label>
						...
						<span class="input-group-addon">
							<i class="glyphicon glyphicon-tag"></i></span>
							<form:input	path="hour" cssClass="form-control form-control-sm" required="required" />
						</span>
					<br />
