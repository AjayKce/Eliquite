	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
				<form:form method="post" action="/console/processEditCollegeAdmin" modelAttribute="admin">
					<form:hidden path="id" />
					...
					<label for="adminName">Admin Name : </label>
						...
						<span class="input-group-addon">
							<i class="glyphicon glyphicon-tag"></i></span>
							<form:input	path="adminName" cssClass="form-control form-control-sm" required="required" />
						</span>
					<br />
