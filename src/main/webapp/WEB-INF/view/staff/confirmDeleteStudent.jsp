...
<div class="container">
		<div class="row">
			<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
				...
				<div class="row">
					<div>
						<form action="confirmDeleteStudent" method="post" style="margin:0px;padding:0px;border:0px;">
							<input type="hidden" name="id" value="<%=student.getId()%>" />
							<button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> confirm delete</button>
						</form>
					</div>
				</div>	
			</div>
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">				
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						<p align="center"><a href="${pageContext.request.contextPath}/confirmDeleteStudent?id=<%=student.getId() %>"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> confirm delete</button></a></p>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"></div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						<p align="center"><a href="${pageContext.request.contextPath}/viewStudents?batch=<%=student.getBatch() %>&semester=<%=student.getSemester() %>&section=<%=student.getSection() %>"><button class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> cancel delete</button></a></p>
					</div>
				</div>		
			</div>
				...
				<div class="row">
					<div>
						<form action="viewStudents" method="post" style="margin:0px;padding:0px;border:0px;">
							<input type="hidden" name="batch" value="<%=student.getBatch() %>" />
							<input type="hidden" name="semester" value="<%=student.getSemester() %>" />
							<input type="hidden" name="section" value="<%=student.getSection() %>" />
							<button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> cancel delete</button>
						</form>	
					</div>
				</div>
			</div>
